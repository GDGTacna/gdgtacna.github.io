...
var SocialApp=function()
{
    ...
    {
        //draw circle
        circle1=new CircleAndroid(Config.HASHTAG_GDGTACNA,"#C5423A",150,"gdgtacna");
        circle2=new CircleAndroid(Config.HASHTAG_GDGPERU,"#0A9853",150,"gdgperu");//("GDGArequipa","#0FF");
        circle3=new CircleAndroid(Config.HASHTAG_TACNA,"#F8C63F",150,"tacnageek");//("AndroidTour","#0FF");
